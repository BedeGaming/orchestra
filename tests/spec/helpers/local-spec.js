...
describe('local Storage Helper', function() {
  ...
  describe('Logic', function() {
    ...
    it('should get item in localStorage', function() {
      this.storage.setItem('test', this.stringA);
      var stringA = this.storage.getItem('test');
      expect(this.stringA).to.eql(stringA);
    });

    it('should get undefined item in localStorage', function() {
      this.storage.setItem('test', undefined);
      var stringA = this.storage.getItem('test');
      expect(stringA).to.be('undefined');
    });
